<script lang="ts">
    ...
    const navigation = [
        ...
        { label: 'Klavierunterricht', href: '/teaching' },
...
<style>
    ...
    .music-divider span:nth-child(2),
    .music-divider span:nth-child(4),
    ...
    @media (max-width: 800px) {
        ...
        .music-divider span:nth-child(n + 9) {
            display: none;
        }
